...
class VitsModel(L.LightningModule):
    ...
    def _compute_loss(self, batch: Batch):
        ...
        # Guardar el componente mel (reconstrucción espectral) para early-stopping:
        # es el término no-adversarial, buen termómetro de fidelidad/overfitting.
    ...
    def validation_step(self, batch: Batch, batch_idx: int):
        ...
        # val_mel: pérdida mel sobre el set de validación (datos no vistos).
        # Es el monitor recomendado para EarlyStopping (mode=min).
        self.log("val_mel", self._last_loss_mel, batch_size=self.batch_size, prog_bar=True)
        return val_loss
